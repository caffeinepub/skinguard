...
export interface backendInterface {
    ...
    getLatestQuestionnaireResult(): Promise<SkinTypeData | null>;
    ...
    getQuestionnaireResults(): Promise<Array<SkinTypeData>>;
    ...
    saveQuestionnaireResults(results: QuestionnaireResult): Promise<void>;
